...
export function SiteHeader() {
  return (
    <header className="sticky top-0 z-40 border-b border-white/10 bg-ink text-white backdrop-blur">
      <div className="flex h-14 items-center justify-between px-4 md:px-6">
        ...
        <nav className="flex items-center gap-5 font-mono text-[11px] tracking-[0.18em]">
          ...
          <a
            ...
            className="ml-2 inline-flex h-8 items-center justify-center border border-white/20 px-3 text-white transition hover:border-hot hover:text-hot"
          >
    ...
    <footer id="contact" className="mt-24 bg-ink text-white">
      <div className="grid gap-10 px-6 py-16 md:grid-cols-4 md:px-10">
        <div className="md:col-span-2">
          ...
          <p className="mt-4 font-mono text-[10px] tracking-[0.25em] text-white/40">MADE IN INDIA · DESIGNED &amp; PRINTED BY SPOOL</p>
        </div>
        <div>
          <p className="font-mono text-[11px] tracking-[0.2em] text-white/40">QUICK LINKS</p>
          ...
          <p className="mt-6 font-mono text-[11px] tracking-[0.2em] text-white/40">POLICIES</p>
          <ul className="mt-3 space-y-2 text-sm">
        ...
        <div>
          <p className="font-mono text-[11px] tracking-[0.2em] text-white/40">CONNECT</p>
          <ul className="mt-3 space-y-2 text-sm">
      ...
      <div id="about" className="border-t border-white/10 px-6 py-10 md:px-10">
        ...
        <p className="mt-2 max-w-md text-sm text-white/50">Each drop is limited. Get told before they sell out.</p>
        <form className="mt-5 flex max-w-md gap-0 border border-white/20" onSubmit={(e) => e.preventDefault()}>
          <input
            type="email"
            required
      ...
      <div className="flex flex-wrap items-center justify-between gap-6 border-t border-white/10 px-6 py-5 font-mono text-[10px] tracking-[0.2em] text-white/40 md:px-10">
